...
\author{Sagarika Yagnyeshwaran, Jophy Lin\thanks{Author for correspondence: 126jlin@frhsd.com}, Rishith Kilaru, Srilekha Dantu, and Vijita Ayyangar\thanks{Authors are with the Science \& Engineering Magnet Program, Manalapan High School, 20 Church Lane, Englishtown, NJ 07726, USA}} % Authors names here
...
\newcommand{\keywords}{electric potential, equipotential lines, electric field visualizations, conductivity, Laplace equation, Poisson equation, electric field mapping, data visualization in electrostatics, finite difference method, Gauss-Seidel, successive over-relaxation} % put your keywords here, lower case unless proper noun or acronym, separated by commas
\makeatletter
\AtBeginDocument{
\hypersetup{%
pdftitle={\@title},
